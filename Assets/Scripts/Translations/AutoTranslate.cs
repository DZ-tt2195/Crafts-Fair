...
public static string Exact_One() => Translator.inst.Translate("Exact_One");
public static string Exact_One_Text() => Translator.inst.Translate("Exact_One_Text");
}
public enum ToTranslate {Game_Designer,Last_Update,Blank,Translator_Credit,Language,Loading,Update_History,Upload_Translation,Download_English,Select_Region,US_West_Coast,US_East_Coast,Europe,Asia,Single_Player,Connect,Enter_username,Disconnect,Disconnected_from_server,Failed_to_connect_to_server,Reconnect,Tutorial_1,Tutorial_2,Create_Room_with_players,Enter_hostname,Join,Type_in_username,Choose_Twists,Custom_Twist_1,Custom_Twist_2,Custom_Twist_3,Custom_Twist_4,Choose,Random,Type_into_chat,Undo,Short,Long,CardIcon,ArtIcon,HouseIcon,SwordIcon,TechIcon,CrownIcon,TokenIcon,Ask_Token_Type,Ask_Submission,Undo_Submission,Ask_Resolve,Confirm,Decline,Ask_Discard,Done,Pause_to_Read,Pause_to_Undo,Game_Over,Leave,Resigned,Switch_Player,Rules,Rules_Summary,Encyclopedia,Close,Any,Placard,Twist,Perfect_Fit,Perfect_Fit_Text,Unnecessary_Surplus,Unnecessary_Surplus_Text,Bare_Minimum,Bare_Minimum_Text,Above_And_Beyond,Above_And_Beyond_Text,Rise_Of_Villages,Rise_Of_Villages_Text,Rise_Of_Kingdoms,Rise_Of_Kingdoms_Text,Rise_Of_Empires,Rise_Of_Empires_Text,Make_Art,Make_Art_Text,Make_House,Make_House_Text,Make_Sword,Make_Sword_Text,Make_Tech,Make_Tech_Text,Upgrade_Two,Upgrade_Two_Text,Strength_In_Numbers,Strength_In_Numbers_Text,Grab_Bag,Grab_Bag_Text,Total_Four,Total_Four_Text,Exact_One,Exact_One_Text}
