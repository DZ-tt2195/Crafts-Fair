...
public static string Ask_Advance (string Token) => Translator.inst.Translate("Ask_Advance", new() {("Token", Token)});
public static string Ask_Retreat (string Token) => Translator.inst.Translate("Ask_Retreat", new() {("Token", Token)});
...
public static string ArtIcon_1() => Translator.inst.Translate("ArtIcon_1");
public static string ArtIcon_2() => Translator.inst.Translate("ArtIcon_2");
public static string ArtIcon_3() => Translator.inst.Translate("ArtIcon_3");
public static string ArtIcon_4() => Translator.inst.Translate("ArtIcon_4");
public static string ArtIcon_5() => Translator.inst.Translate("ArtIcon_5");
public static string ArtIcon_6() => Translator.inst.Translate("ArtIcon_6");
public static string HouseIcon_1() => Translator.inst.Translate("HouseIcon_1");
public static string HouseIcon_2() => Translator.inst.Translate("HouseIcon_2");
public static string HouseIcon_3() => Translator.inst.Translate("HouseIcon_3");
public static string HouseIcon_4() => Translator.inst.Translate("HouseIcon_4");
public static string HouseIcon_5() => Translator.inst.Translate("HouseIcon_5");
public static string HouseIcon_6() => Translator.inst.Translate("HouseIcon_6");
public static string SwordIcon_1() => Translator.inst.Translate("SwordIcon_1");
public static string SwordIcon_2() => Translator.inst.Translate("SwordIcon_2");
public static string SwordIcon_3() => Translator.inst.Translate("SwordIcon_3");
public static string SwordIcon_4() => Translator.inst.Translate("SwordIcon_4");
public static string SwordIcon_5() => Translator.inst.Translate("SwordIcon_5");
public static string SwordIcon_6() => Translator.inst.Translate("SwordIcon_6");
public static string TechIcon_1() => Translator.inst.Translate("TechIcon_1");
public static string TechIcon_2() => Translator.inst.Translate("TechIcon_2");
public static string TechIcon_3() => Translator.inst.Translate("TechIcon_3");
public static string TechIcon_4() => Translator.inst.Translate("TechIcon_4");
public static string TechIcon_5() => Translator.inst.Translate("TechIcon_5");
public static string TechIcon_6() => Translator.inst.Translate("TechIcon_6");
...
public static string Discard_Instruction() => Translator.inst.Translate("Discard_Instruction");
...
public static string Advance_Two() => Translator.inst.Translate("Advance_Two");
public static string Advance_Two_Text() => Translator.inst.Translate("Advance_Two_Text");
}
public enum ToTranslate {Game_Designer,Last_Update,Blank,Translator_Credit,Language,Loading,Update_History,Upload_Translation,Download_English,Select_Region,US_West_Coast,US_East_Coast,Europe,Asia,Single_Player,Connect,Enter_username,Disconnect,Disconnected_from_server,Failed_to_connect_to_server,Reconnect,Tutorial_1,Tutorial_2,Create,Create_Room_with_players,Enter_hostname,Join,Type_in_username,Encyclopedia,Close,Choose_Twists,Custom_Twist_1,Custom_Twist_2,Custom_Twist_3,Custom_Twist_4,Choose,Random,Type_into_chat,Undo,Short,Long,CardIcon,ArtIcon,HouseIcon,SwordIcon,TechIcon,CrownIcon,TokenIcon,ArtIcon_1,ArtIcon_2,ArtIcon_3,ArtIcon_4,ArtIcon_5,ArtIcon_6,HouseIcon_1,HouseIcon_2,HouseIcon_3,HouseIcon_4,HouseIcon_5,HouseIcon_6,SwordIcon_1,SwordIcon_2,SwordIcon_3,SwordIcon_4,SwordIcon_5,SwordIcon_6,TechIcon_1,TechIcon_2,TechIcon_3,TechIcon_4,TechIcon_5,TechIcon_6,Ask_Token_Type,Ask_Submission,Undo_Submission,Resolve_Twist,Confirm,Decline,Discard_Instruction,Done,Pause_to_Read,Pause_to_Undo,Game_Over,Leave,Resigned,Switch_Player,Rules,Rules_Summary,Placard,Perfect_Fit,Perfect_Fit_Text,Unnecessary_Surplus,Unnecessary_Surplus_Text,Bare_Minimum,Bare_Minimum_Text,Above_And_Beyond,Above_And_Beyond_Text,Strength_In_Numbers,Strength_In_Numbers_Text,Rise_Of_Villages,Rise_Of_Villages_Text,Rise_Of_Kingdoms,Rise_Of_Kingdoms_Text,Rise_Of_Empires,Rise_Of_Empires_Text,Twist,Make_Art,Make_Art_Text,Make_House,Make_House_Text,Make_Sword,Make_Sword_Text,Make_Tech,Make_Tech_Text,Advance_Two,Advance_Two_Text}
