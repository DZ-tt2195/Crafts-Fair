...
public static string Online_Advance_Token (string Player,string Num,string Token1,string Token2) => $"Online_Advance_Token\tPlayer\t{Player}\tNum\t{Num}\tToken1\t{Token1}\tToken2\t{Token2}";
public static string Online_Retreat_Token (string Player,string Num,string Token1,string Token2) => $"Online_Retreat_Token\tPlayer\t{Player}\tNum\t{Num}\tToken1\t{Token1}\tToken2\t{Token2}";
