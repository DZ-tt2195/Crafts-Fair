...
public static string Online_Draw_Buyer (string Player,string Card) => $"Online_Draw_Buyer\tPlayer\t{Player}\tCard\t{Card}";
public static string Online_Draw_Buyer_Others (string Player) => $"Online_Draw_Buyer_Others\tPlayer\t{Player}";
...
public static string Online_Discard_Buyer (string Player,string Card) => $"Online_Discard_Buyer\tPlayer\t{Player}\tCard\t{Card}";
...
public static string Online_Trends_To_Resolve (string Num) => $"Online_Trends_To_Resolve\tNum\t{Num}";
